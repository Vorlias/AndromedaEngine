...
inline static ImGuiStyle GetImguiStyle() {
	...
	colors[ImGuiCol_TextDisabled] = ImVec4(0.31f, 0.31f, 0.31f, 1.00f);
	...
	colors[ImGuiCol_FrameBgActive] = ImVec4(0.24f, 0.22f, 0.60f, 1.00f);
	...
	colors[ImGuiCol_CheckboxSelectedBg] = ImVec4(0.02f, 0.02f, 0.02f, 1.00f);
	colors[ImGuiCol_SliderGrab] = ImVec4(0.50f, 0.51f, 1.00f, 1.00f);
	colors[ImGuiCol_SliderGrabActive] = ImVec4(0.54f, 0.55f, 1.00f, 1.00f);
	colors[ImGuiCol_Button] = ImVec4(0.02f, 0.02f, 0.02f, 1.00f);
	colors[ImGuiCol_ButtonHovered] = ImVec4(0.04f, 0.04f, 0.04f, 1.00f);
	colors[ImGuiCol_ButtonActive] = ImVec4(0.24f, 0.22f, 0.60f, 1.00f);
	colors[ImGuiCol_Header] = ImVec4(0.02f, 0.02f, 0.02f, 1.00f);
	colors[ImGuiCol_HeaderHovered] = ImVec4(0.04f, 0.04f, 0.04f, 1.00f);
	colors[ImGuiCol_HeaderActive] = ImVec4(0.24f, 0.22f, 0.60f, 1.00f);
	colors[ImGuiCol_Separator] = ImVec4(0.03f, 0.03f, 0.03f, 1.00f);
	...
	colors[ImGuiCol_TextSelectedBg] = ImVec4(0.24f, 0.22f, 0.60f, 1.00f);
	colors[ImGuiCol_TreeLines] = ImVec4(0.43f, 0.43f, 0.50f, 0.50f);
	colors[ImGuiCol_DragDropTarget] = ImVec4(0.50f, 0.51f, 1.00f, 1.00f);
	colors[ImGuiCol_DragDropTargetBg] = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
	colors[ImGuiCol_UnsavedMarker] = ImVec4(1.00f, 1.00f, 1.00f, 1.00f);
	colors[ImGuiCol_NavCursor] = ImVec4(0.50f, 0.51f, 1.00f, 1.00f);
